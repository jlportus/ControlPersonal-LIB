...
public class PermisoOficial extends AusenciaImpl {
	...
	public PermisoOficial() {
		super();
		
	}

	public PermisoOficial(String tipo, Instant fechaInicio, Instant fechaFin, PersonaConPermiso persona) {
		this();
